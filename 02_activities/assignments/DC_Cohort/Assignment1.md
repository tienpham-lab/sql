...
```
Databases are never neutral. Qadri's account of Pakistan's NADRA system reveals how technical decisions, seemingly mundane choices about database schema and data fields, encode deeply political assumptions about who exists, who belongs, and whose relationships the state recognizes. When a database requires every citizen to be linked to a married, two-parent household, it does not merely record social reality; it constructs and enforces it.
What strikes me most is how this mirrors databases I encounter in my own life and research. In Vietnam's Mekong Delta, household registration systems (hộ khẩu) similarly define family through state-approved structures, creating barriers for those who move, divorce, or form non-traditional households. Climate-displaced families who migrate informally often find themselves administratively invisible, unable to access education, healthcare, or social support because their household registration no longer matches their physical location. Like Riz in Qadri's story, their existence is technically valid but computationally unrecognized.
Qadri's article pushes me to ask: whose assumptions get built into the systems we design? Database architects make choices that appear technical but are fundamentally social — whether gender is a boolean or an ENUM, whether parentage must be biological, whether family must be nuclear. These choices reflect the worldview of those with power to design the system, and they disproportionately burden those who fall outside the norm.
As someone who works at the intersection of data, education, and climate justice, I find this deeply relevant. Data systems that claim to measure vulnerability or track displacement often reproduce the same exclusions as the systems Qadri describes. Girls who leave school during floods, families who move without formal documentation, youth who fall between administrative categories, they disappear from the data, and therefore from policy responses.
The lesson I take from Qadri is not that databases are inherently harmful, but that they require what she calls both sociological and technological imagination. Good design must anticipate change, acknowledge complexity, and above all, ask who might be made invisible by the choices being made today.
```
